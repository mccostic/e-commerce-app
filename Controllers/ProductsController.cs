...
namespace ecom.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(IProductRepository productRepository, ICategoryRepository categoryRepository, ApplicationDbContext context, ShoppingCart shoppingCart)
        {
        ...
        public async Task<IActionResult> ProductPage(int? id)
        {
            ...
            var cartItem = await _shoppingCart.GetSingleItem(product);
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,ShortDescription,LongDescription,Price,PreviewIage,inStock,CategoryId")] Product product)
        {
          ...
          //  _categoryRepository.GetById(product.CategoryId);
