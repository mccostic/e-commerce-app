...
namespace ecom.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        {
            Product product = await _productRepository.GetById(id);            returnUrl = returnUrl.Replace("%2F", "/");
            ...
            return RedirectToAction("Index", new { isValidAmount = isValidAmount, returnUrl = returnUrl });
